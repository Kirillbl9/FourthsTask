...
import Inquiries.ThirdTask_3_1;
import Inquiries.ThirdTask_3_2;
import Inquiries.ThirdTask_3_3;
import Inquiries.ThirdTask_3_4;
...
public final class JDBC {
    ...
    public static void main(@NotNull String[] args) throws SQLException {
        ...
        try {
            ...
            // ThirdTask_3_2.thirdTask_3_2(2000);
